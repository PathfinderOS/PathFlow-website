...
MCP Hub
  ...
  +-- Internal API MCP`,
        ...
        paragraphsAfter: [
          ...
          [
            'This becomes particularly relevant when MCP is being used as an integration layer across several client systems. ',
            { text: 'Pathflow MCP', href: '/platform/mcp' },
            ' is useful in that kind of environment because agent access can stay attached to the client, project, request, resources, architecture, and handoff state around the work. That context helps operations, but it does not make the surrounding permission model optional.',
          ],
        ],
      },
      {
...
proxy traffic`,
          ...
          },
          {
            ...
            paragraphs: [
              ...
              [
                'For client environments, documenting that authority is useful before deployment. This is where ',
                { text: 'system architecture', href: '/solutions/architecture' },
                ' stops being a drawing exercise and becomes an access review: which MCP services can reach which applications, where credentials live, what processes are being launched, and where tenant or network boundaries exist.',
              ],
            ],
          },
        ],
          ...
          },
          {
            ...
            paragraphs: [
              ...
              [
                ...
                ' becomes more valuable when it carries the operational evidence too: what was changed, which systems were involved, which credentials were used by reference, what remains operational, and where responsibility sits after delivery.',
              ],
            ],
          },
        ],
...
patch management`,
        ...
        paragraphsAfter: [
          ...
          [
            'The practical Pathflow angle is simple: keep the MCP manager, the systems behind it, and the final client record close enough that review does not depend on memory. The rest of the ',
            { text: 'Pathflow Resources', href: '/resources' },
            ' library is there for the adjacent infrastructure, automation, and handoff questions that usually follow.',
          ],
